...
- At a safe milestone in a long task, refresh `HANDOFF.md` and compact or start fresh when reliable telemetry shows root input context approaching 100k tokens or after two to three completed slices. Do not compact mid-edit, mid-test, or while an agent owns unreported work, and do not carry a long transcript merely to preserve facts that already exist in durable repository files.
