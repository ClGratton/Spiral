...
for ((ATTEMPT = 1; ATTEMPT <= ITERATIONS; ++ATTEMPT)); do
    ...
    DIAGNOSTICS_PATTERN='Editor renderer capability diagnostics rendered: profile=Phase 3 Vulkan Bootstrap Presentation V1, adapter=.+, qualification=Bootstrap, formats=[1-9][0-9]*, features=7, groups=1, candidates=[1-9][0-9]*'
