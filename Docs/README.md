...
| [Docs/Architecture/WATER_ARCHITECTURE_AND_RESEARCH.md](Architecture/WATER_ARCHITECTURE_AND_RESEARCH.md) | Accepted planning contract | Layered deep/local/hero water, KWS2/Sea of Thieves/Horizon research, optical rendering, terrain and lighting integration, bounded interaction, optional physics, performance, and qualification. |
